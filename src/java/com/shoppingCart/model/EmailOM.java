 ...
 * @author FIA
 */
public class EmailOM {

    private EmailOM() {
    }
    private static final String username = "javatest69";
    private static final String password = "likeusername";
    ...
    public static void Send(String recipientEmail, String title, String message) throws AddressException, MessagingException {
        EmailOM.Send(recipientEmail, "", title, message);
    }
