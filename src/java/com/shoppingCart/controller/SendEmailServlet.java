...
import com.shoppingCart.model.BillExtractor;
import com.shoppingCart.model.EmailOM;
...
public class SendEmailServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        BillExtractor extractor = new BillExtractor(buyList.getCartItem(), customerName, customerEmail);
        EmailOM.Send(customerEmail, "", "Transaction Details", extractor.extractBill());
        session.invalidate();
